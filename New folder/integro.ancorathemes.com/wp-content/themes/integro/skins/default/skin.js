(function() {
    ...
    function integro_skin_post_header_init() {
    ...
    integro_add_filter('trx_addons_filter_skills_pie_options', function(opt) {
        opt.animateScale = false;
        return opt;
    });
    integro_add_filter('integro_filter_select_container_selector', function(selector) {
    ...
    integro_add_filter('trx_addons_filter_slider_init_args', function($param, $init) {
    ...
    function skin_blogger_toggle_filter_add_element() {
        if (jQuery('.content').find(".sc_style_toggle").length > 0) {
            jQuery(" .sc_style_toggle").each(function() {
                var toggle_title = INTEGRO_STORAGE['toggle_title'];
                    ...
                    if ($share_items.length > 0) {
                        $share_items.addClass('inited').on('click', '.social_item_popup', function(e) {
                            ...
                            if (url != '') {
                                ...
                                var msg = $self.data('message') ? $self.data('message') : INTEGRO_STORAGE['msg_copied'];
                                if (msg) {
    ...
    function integro_skin_audio_init() {
    ...
    jQuery(window).load(function() {
        integro_skin_audio_init();
        skin_add_custom_width_filter_list();
        background_image_portfolio_stretch();
        integro_skin_post_header_init();
    });
    jQuery(document).on('action.ready_integro', function() {
        ...
        jQuery('.tribe-events-view').on('beforeAjaxComplete.tribeEvents beforeAjaxSuccess.tribeEvents beforeAjaxError.tribeEvents', integro_tribe_events_after_ajax);

        function integro_tribe_events_after_ajax(jqXHR, textStatus) {
            setTimeout(function() {
                jQuery('.tribe-events-view').on('beforeAjaxComplete.tribeEvents beforeAjaxSuccess.tribeEvents beforeAjaxError.tribeEvents', integro_tribe_events_after_ajax);
            }, 10);
        }
        ...
        function mc4wpGO(form) {
            jQuery(form).each(function() {
                ...
                btn.on('click', function(e) {
                    ...
                    var rez = integro_form_validate(form, {
                        ...
                        rules: [{
                            ...
                            min_length: {
                                value: 7,
                                message: INTEGRO_STORAGE['mc4wp_msg_email_min']
                            },
                            max_length: {
                                value: 60,
                                message: INTEGRO_STORAGE['mc4wp_msg_email_max']
                            },
                            mask: {
        ...
        integro_add_filter('integro_filter_mobile_menu_close_timeout', function(timeout, $menu) {
            return 1000;
        });
        ...
        function integro_skin_open_panel(id) {
        ...
        jQuery('.trx_addons_panel_menu_link:not(.panel_inited)').addClass('panel_inited').on('click', function(e) {
            integro_skin_open_panel(jQuery(this).attr('href').substring(1));
            e.preventDefault();
            return false;
        });

        function integro_skin_close_panel() {
        ...
        jQuery($search_wrap.each(function() {
            ...
            search_field.on('keyup', function(e) {
                if (e.keyCode === 27) {
                    ...
                    setTimeout(function() {
                        integro_search_close($search_wrap_init);
    ...
    function integro_search_close($search_wrap_init) {
    ...
    jQuery(document).on('action.add_googlemap_styles', function(e) {
        ...
        TRX_ADDONS_STORAGE['googlemap_styles']['black'] = [{
            "featureType": "all",
            "elementType": "geometry",
            "stylers": [{
                "color": "#262c33"
    ...
    jQuery(document).on('action.scroll_integro', function() {});
    jQuery(document).on('action.resize_integro', function() {
        extra_margin_top_video_popup_button();
        integro_skin_post_header_init();
        skin_add_custom_width_filter_list();
    ...
    jQuery('.integro_woocommerce_filters_button,.sidebar > .sidebar_close,.sidebar_overlay').on('click', function(e) {
